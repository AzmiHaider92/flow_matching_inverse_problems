...
class GaussianDiffusion:
    ...
    def shortcut_targets(self, model, ema, x1, xt, t, noise, model_kwargs, sc_frac):
    ...
    def training_losses(self, model, x_start, t, ema=None, model_kwargs=None, noise=None, sc_frac=0.25):
        """
        ...
        if self.model_mean_type == ModelMeanType.SHORTCUT:
            target = self.shortcut_targets(model, ema, x_start, x_t, t, noise, model_kwargs, sc_frac)
        else:
            target = {
